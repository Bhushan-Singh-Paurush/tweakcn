      ...
      <DropdownMenu>
        <DropdownMenuTrigger asChild className=" cursor-pointer">
          <div className=" flex items-center gap-3  text-default-800 ">
           ...
           {session?.logo ? <Image
              src={session?.logo as string}
              alt={session?.name?.charAt(0) as string}
              width={36}
              height={36}
              className="rounded-full"
            /> : <div className=" w-[36px] h-[36px] rounded-full flex items-center justify-center bg-secondary">B</div>
           }
